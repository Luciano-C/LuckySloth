...
const hit = (hitter, target, extra) => {
    const hit_list = [
        ...
        `${hitter} decided to do a Thor cosplay and hits ${target} with a hammer.`,
        ...
        `${hitter} said "You are ugly" to ${target}. No physical damage was done, but now ${target} is crying inside :smiling_face_with_tear:`,
        `${hitter} used ${target} as a battering ram to break down a castle door.`,
        `${hitter} knocks down ${target} with an uppercut.`,
